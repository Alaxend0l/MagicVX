...
enum Funcs
{
	CameraManager_GetActiveCameras = 0x40A4B0,
	CameraManager_GetCameraByIndex = 0x40A4C0,
	CameraManager_GetNewCamera = 0x40A560,
	Camera_SetPlayer = 0x40CA50,
	...
	Player_RefreshInterface = 0x43EB20,
	Player_SetThing = 0x43EC10,
	PlayerManager_NewHumanPlayer = 0x440060,
	PlayerManager_NewAIPlayer = 0x4400C0,
	PlayerManager_PlayerHumanCount = 0x440130,
	PlayerManager_PlayerCount = 0x440160,
	PlayerManager_GetPlayerByIndex = 0x440180,
	PlayerManager_GetHumanPlayerByIndex = 0x4401B0,
	PlayerManager_RemovePlayer = 0x440360,
	ArmageddonDropShip = 0x4453E0,
	InterfaceInputAnimator_Initialize = 0x445C60,
	StateProgressionManager_RestartCurrentLevel = 0x4460A0,
	StateManager_GotoState = 0x447FC0,
	ActionVehicleTeleport = 0x4498B0,
	ThingManager_DARYL_CreateThing = 0x44D0B0,
	ViewManager_SetCamera = 0x4509A0,
	ViewManager_EnableView = 0x4509F0,
	Gfx_SetRenderWindowSize = 0x450A20,
	ViewManager_SetSinglePlayer = 0x450A60,
	ViewManager_SetTwoPlayerHorizontal = 0x450AB0,
	ViewManager_SetThreePlayer = 0x450B10,
